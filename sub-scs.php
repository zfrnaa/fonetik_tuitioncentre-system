...
<div id="page">
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
				<li style="background: url(userres/images/science.jpg) center; background-size: cover;">
					<div class="overlay-gradient"></div>
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 text-center slider-text">
								<div class="slider-text-inner">
									<h1>Ignite the flame of science, illuminate the path of knowledge and explore the
										mysteries of nature, guide wisdom to grow.</h1>
				...
				<li style="background-image: url(userres/images/science2.jpg);">
					<div class="overlay-gradient"></div>
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 text-center slider-text">
								<div class="slider-text-inner">
									<h1>Science nourishes the heart, education shapes the future. </h1>
				...
				<div class="col-md-10 col-md-offset-1">
					<div class="row animate-box">
						<div class="item col-md-6 col-md-offset-3 text-center">
							...
							<img src="userres/images/alen.jpg" alt="" height="400" width="400">
							<br>Tutor<br><h4>Sir Alen</h4></span>
							<blockquote style="color: white">
								<p>&ldquo;Be glad to explore, be brave to innovate, be a pioneer of the
									times.&rdquo;</p>
							</blockquote>
						</div>
					</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center">
					<h2 class="orange-heading">Course Information</h2>
					<h4>Science briefing</h4>
					<p>Science is a combined course which combining biology, physics, and chemistry into one course is
						becoming increasingly common, especially at the introductory level. This interdisciplinary
						approach helps students see how these sciences are interconnected and relevant to the real
						world.
					</p>
					<h4>Personal Anecdote </h4>
					<p>This yearning to understand, to explore, and to uncover the hidden magic – that's the heart of
						science. At Fonetik Tuition Centre we nurture that spark, transforming curiosity into knowledge,
						and awe into intellectual journeys. We invite you to embark on an adventure where science isn't
						just a subject, but a thrilling expedition into the unknown, fueled by your own insatiable
						wonder.</p>
					<h4>Tutor Expertise</h4>
					<p>Welcome to a learning space where science isn't just a subject, it's an adventure! Here, our
						passionate tutors aren't just teachers, they're explorers, ready to embark on a journey of
						discovery alongside you. Whether you're unraveling the mysteries of the universe, delving into
						the intricacies of the human body, or unlocking the power of chemical reactions, we're here to
						equip you with the knowledge, skills, and confidence to excel in science and beyond.</p>
				</div>
			</div>
		</div>
	</div>
