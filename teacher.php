...
<div id="page">
						...
						<div class="row">
							<div class="col-md-8 col-md-offset-2 text-center slider-text">
								<div class="slider-text-inner">
									<h1 class="heading-section">Our Tutors</h1>
									<h2>Please join us to help our young generation in good shape</h2>
								</div>
							</div>
						</div>
					</div>
	...
	<div id="fh5co-staff">
		<div class="container">
			<div class="row">
				<div class="col-md-3 text-center">
					<div class="staff">
						<div class="staff-img" style="background-image: url(userres/images/zafran.jpg);">
							<ul class="fh5co-social">
								<li><a href="#"><i class="icon-facebook2"></i></a></li>
						...
						<span>Teacher</span>
						<h3><a href="#">Encik Zafran</a></h3>
						<p>Melayu bukan sekadar bahasa, tetapi identiti dan warisan kita</p>
						<span>
							<audio controls>
								<source src="userres/guitar-bgmusic.wav" type="audio/wav">
							</audio>
						</span>
					</div>
				</div>
				<div class="col-md-3 animate-box text-center">
					<div class="staff">
						<div class="staff-img" style="background-image: url(userres/images/ida.jpg);">
							<ul class="fh5co-social">
								<li><a href="#"><i class="icon-instagram"></i></a></li>
								<li><a href="#"><i class="icon-twitter2"></i></a></li>
								<li><a href="#"><i class="icon-linkedin2"></i></a></li>
						...
						<span>Teacher</span>
						<h3><a href="#">Miss Faridah</a></h3>
						<p>I will teach you English as simple as Eat, Sleep, Repeat</p>
						<span>
							<audio controls>
								<source src="userres/guitar-bgmusic.wav" type="audio/wav">
							</audio>
				...
				<div class="col-md-3 animate-box text-center">
					<div class="staff">
						<div class="staff-img" style="background-image: url(userres/images/zuraidah.jpg);">
							<ul class="fh5co-social">
								<li><a href="#"><i class="icon-facebook2"></i></a></li>
								<li><a href="#"><i class="icon-twitter2"></i></a></li>
								<li><a href="#"><i class="icon-linkedin2"></i></a></li>
						...
						<span> Teacher</span>
						<h3><a href="#">Cik Zuraidah</a></h3>
						<p>Setiap kejayaan datang bersama usaha</p>
						<span>
							<audio controls>
								<source src="userres/guitar-bgmusic.wav" type="audio/wav">
							</audio>
				...
				<div class="col-md-3 animate-box text-center">
					<div class="staff">
						<div class="staff-img" style="background-image: url(userres/images/dina.jpg);">
							<ul class="fh5co-social">
								<li><a href="#"><i class="icon-facebook2"></i></a></li>
								<li><a href="#"><i class="icon-twitter2"></i></a></li>
								<li><a href="#"><i class="icon-linkedin2"></i></a></li>
						...
						<span>Teacher</span>
						<h3><a href="#">Cik Irdina</a></h3>
						<p>Pemenang tidak akan kalah di medan perang</p>
						<span>
							<audio controls>
								<source src="userres/guitar-bgmusic.wav" type="audio/wav">
							</audio>
				...
				<div class="row">
					...
					<div class="col-md-3 animate-box text-center">
						<div class="staff">
							<div class="staff-img" style="background-image: url(userres/images/alen.jpg);">
								<ul class="fh5co-social">
									<li><a href="#"><i class="icon-facebook2"></i></a></li>
									<li><a href="#"><i class="icon-twitter2"></i></a></li>
									<li><a href="#"><i class="icon-linkedin2"></i></a></li>
							...
							<span>Teacher</span>
							<h3><a href="#">Sir Alen</a></h3>
							<p>"May the knowledge bring you light on your path"</p>
							<span>
							<audio controls>
								<source src="userres/guitar-bgmusic.wav" type="audio/wav">
							</audio>
					...
					<div class="col-md-3 animate-box text-center">
						<div class="staff">
							<div class="staff-img" style="background-image: url(userres/images/fahmi1.jpeg);">
								<ul class="fh5co-social">
									<li><a href="#"><i class="icon-facebook2"></i></a></li>
									<li><a href="#"><i class="icon-twitter2"></i></a></li>
									<li><a href="#"><i class="icon-linkedin2"></i></a></li>
							...
							<span>Teacher</span>
							<h3><a href="#">Ustaz Fahmi</a></h3>
							<p>"Percayalah kepada takdir bahawa kamu semua boleh berjaya"</p>
							<span>
							<audio controls>
								<source src="userres/guitar-bgmusic.wav" type="audio/wav">
							</audio>
		...
		<div class="container">
			<div class="row">
				<h2 class="text-center">Teachers List for Fonetik Tuition Centre</h2>
			</div>
			<div class="col-md-12">
