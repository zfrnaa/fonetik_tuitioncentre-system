...
<div id="page">
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
				<li style="background: url(userres/images/subbm-carousel1.jpg) center; background-size: cover;">
					<div class="overlay-gradient"></div>
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 text-center slider-text">
								<div class="slider-text-inner">
									<h1>Marilah bersama memertabatkan Bahasa Ibunda kita</h1>
				...
				<div class="col-md-10 col-md-offset-1">
					<div class="row animate-box">
						<div class="item col-md-6 col-md-offset-3 text-center">
							...
							<img src="userres/images/zafran.jpg" alt="" height="400" width="400">
							<br>Tutor<br><h4>Zafran</h4></span>
							<blockquote style="color: white">
								<p>&ldquo;Melayu bukan sekadar bahasa, tetapi identiti dan warisan&rdquo;</p>
							</blockquote>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center">
					...
					<h4>Kosa Kata</h4>
					<p>Tingkatkan penguasaan kosa kata SPM anda dalam kelas Bahasa Melayu saya! Pelajari istilah-istilah
						penting dalam Bahasa Melayu, Inggeris, Sejarah, Matematik Moden, Matematik Tambahan, dan Sains
						untuk menajamkan pemahaman dan meningkatkan skor peperiksaan anda.</p>
					<h4>Tatabahasa</h4>
					<p>Kuasai tatabahasa dan bina ayat yang gramatis dan berkesan dengan kelas SPM kami. Pelajari teknik
						penulisan yang mantap, struktur ayat, dan penggunaan imbuhan yang tepat dalam Bahasa Melayu.</p>
					<h4>Bahasa Klasik</h4>
					<p>Jelajahi khazanah Bahasa Melayu klasik dengan kelas kami! Pelajari karya-karya agung, teknik
						penulisan tradisional, dan unsur-unsur bahasa klasik yang memperkaya pemahaman anda terhadap
						Bahasa Melayu dan subjek Sejarah.</p>
					<h4>Karangan</h4>
					<p>Asah kemahiran menulis anda dengan kelas SPM saya! Pelajari teknik menulis karangan yang
						berstruktur, isi yang padat, dan gaya bahasa yang menarik dalam Bahasa Melayu, Inggeris, dan
						lain-lain subjek. Tingkatkan keyakinan anda untuk menulis karangan cemerlang!</p>
				</div>
			</div>
		</div>
	</div>
