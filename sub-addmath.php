...
<div id="page">
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
				<li style="background: url(userres/images/pic_addmath.jpg) center; background-size: cover;">
					<div class="overlay-gradient"></div>
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 text-center slider-text">
								<div class="slider-text-inner">
									<h1>“Pure mathematics is, in its way, the poetry of logical ideas.” — Albert Einstein</h1>
									<p><a class="btn btn-primary btn-lg" href="#">Join Us Now!</a></p>
								</div>
							</div>
						</div>
					</div>
				</li>
				<li style="background-image: url(userres/images/pic_addmath1.jpg);">
					<div class="overlay-gradient"></div>
					<div class="container">
						<div class="row">
							<div class="col-md-8 col-md-offset-2 text-center slider-text">
								<div class="slider-text-inner">
									<h1>“The only way to learn mathematics is to do mathematics.” — Paul Halmos</h1>
	...
	<div id="fh5co-subjek" style="background-image: url(userres/images/userpage-bg2.jpg);">
		<div class="overlay"></div>
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					<h2><span>TUTOR</span></h2>
				</div>
			</div>
			<div class="row backdrop-blur" style="border-radius: 10px; background-color: rgb(255 255 255 / 0.4)">
				<div class="col-md-10 col-md-offset-1">
					<div class="row animate-box">
						<div class="item col-md-6 col-md-offset-3 text-center">
							<div class="user"></div>
							<h3>Meet the tutor</h3>
							<img src="userres/images/fahmi1.jpeg" alt="" height="400" width="400">
							<br>Tutor<br><h4>Sir Fahmy</h4></span>
							<blockquote style="color: black">
								<p>&ldquo;In the intricate tapestry of knowledge, mathematics weaves the threads of logic, precision, and infinite possibilities, creating a masterpiece that unveils the beauty of the universe.&rdquo;</p>
							</blockquote>
						</div>
					</div>
				</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center">
					<h2 class="orange-heading">Course Structure</h2>
					<h4>Diagnostic Assessment</h4>
					<p>Before diving into new material, conduct a diagnostic assessment to evaluate the current knowledge 
                        levels of your students. This helps you identify any gaps in their understanding and tailor your 
                        teaching approach accordingly. By understanding their strengths and weaknesses, you can focus on 
                        areas that require more attention and provide targeted support.</p>
					<h4>Interactive Teaching</h4>
					<p>Employ an interactive teaching approach that involves student participation. Use examples, discussions,
                        and hands-on activities to make the learning experience more engaging and dynamic. This approach not
                        only enhances understanding but also encourages students to actively think and apply mathematical concepts.</p>
					<h4>Problem-Solving Approach</h4>
					<p>Additional mathematics often involves complex problem-solving. Emphasize a problem-solving approach in your teaching.
                        Encourage students to analyze problems, identify relevant information, and apply appropriate mathematical 
                        techniques to find solutions. This not only helps them excel in exams but also develops critical thinking 
                        and analytical skills that are valuable beyond the classroom.</p>
					<h4>Use of Technology</h4>
					<p>Integrate technology tools into your teaching to enhance the learning experience. Graphing calculators, 
                        educational software, and online resources can help visualize abstract concepts and make mathematical 
                        principles more accessible. By incorporating technology, you create a more interactive and modern learning
                        environment, catering to different learning styles and fostering a deeper understanding of additional mathematics concepts.</p>
				</div>
			</div>
		</div>
	</div>
