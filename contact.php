...
<head>
	...
	<title>Fonetik Tuition Centre &mdash; Contact Us</title>
			...
			<div class="row">
				<div class="col-md-6 col-md-push-1 animate-box">
					...
					<div class="fh5co-contact-info">
						...
						<ul>
							<li class="address">Universiti Tun Hussein Onn Malaysia (UTHM) <br> Persiaran Tun Dr.
								Ismail, 86400 Parit Raja, Johor
							</li>
							<li class="phone"><a href="tel://1234567920">+ 06-6534221</a></li>
							<li class="email"><a href="mailto:info@yoursite.com">fonetiktuitionsentre.com</a></li>
						</ul>
						<div class="mapouter">
							<div class="gmap_canvas">
								<iframe
									src="https://maps.google.com/maps?q=university%20tun%20hussein%20onn%20&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
									style="width: 430px; height: 400px;"></iframe>
								<style>.mapouter {
                                        position: relative;
                                        height: 300px;
                                        width: 330px;
...
<script src="userres/js/google_map.js"></script>
<!-- Count Down -->
